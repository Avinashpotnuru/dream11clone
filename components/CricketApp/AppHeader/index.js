...
const AppHeader = () => {
  return (
    <div>
      {/* <div>
        <div
          className="sm:bg-landingBackGround bg-[url('/cricket.svg')]  bg-cover min-h-[80vh] sm:min-h-[100vh] "
          style={{ backgroundPosition: "center bottom" }}
        >
          <div className="grid grid-cols-2 ">
            <div className="flex flex-col justify-center items-center p-2">
              <img className="h-[94px] w-[118px] my-3" src="/win11logo.png" />
      ...
      {/* <div className="  bg-[url('/mob.svg')] relative md:bg-[url('/tabWin11.svg')]  xl:bg-[url('/win11desk.svg')] bg-cover   h-[600px] sm:max-[1200px]    w-[100%] flex justify-center items-center p-5 ">
        <div className="flex flex-col absolute mt-16 pl-4 top-0 z-10 md:p-6 left-0 justify-center items-center xl:p-8 w-[50%]     ">
        ...
        <div className="flex justify-end absolute top-0 right-0   items-center   ">
          <img
            className="h-[220px] w-[220px] sm:h-[300px] sm:w-[300px] md:h-[360px] md:w-[360px] lg:h-[400px] lg:w-[400px]  xl:h-[600px] xl:w-[750px] "
            src="/cricket.png"
          />
        </div>

        <div className=" flex-col justify-center mt-32 items-center md:hidden bg-red-300 ">
          <h1 className="text-[16px] font-[600] text-[#003718]">
            Live your sports fantasy today !
          </h1>
          <div className="flex   justify-around items-center ">
